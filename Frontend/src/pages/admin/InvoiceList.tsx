        ...
        <Table>
          <TableHeader className="bg-slate-50 border-b border-slate-100">
            <TableRow className="hover:bg-transparent">
              <TableHead className="h-12 uppercase text-[10px] font-black tracking-wider text-slate-400 pl-6">Invoice ID / Issue</TableHead>
              <TableHead className="h-12 uppercase text-[10px] font-black tracking-wider text-slate-400">B2B client</TableHead>
              <TableHead className="h-12 uppercase text-[10px] font-black tracking-wider text-slate-400">Logistics Route</TableHead>
              <TableHead className="h-12 uppercase text-[10px] font-black tracking-wider text-slate-400">Total Billed</TableHead>
              <TableHead className="h-12 uppercase text-[10px] font-black tracking-wider text-slate-400">State Clearance</TableHead>
                ...
                <TableRow key={inv.id} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors h-16">
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <p className="text-xs font-black text-slate-800 leading-none">{inv.clientName}</p>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-1.5 text-xs font-bold text-[#1E293B]">
                      <span>{inv.route.source}</span>
                      <ArrowRight className="w-3 h-3 text-slate-400" />
                      <span>{inv.route.destination}</span>
                    </div>
